...
`
	...
	t.Run("Valid YAML", func(t *testing.T) {
		...
		if manifest.Components.Longhorn.Version != "v1.0.0" || manifest.Components.Longhorn.Location != "http://example.com" || manifest.Components.Longhorn.Namespace != "longhorn-system" {
			t.Errorf("expected longhorn with version v1.0.0, location http://example.com, and namespace longhorn-system, got %v", manifest.Components.Longhorn)
		}
